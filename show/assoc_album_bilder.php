...
<input type="checkbox" name="bid[]" value="<?=$Bild["bid"];?>" /><?=$Bild["datei"];?><br />
<img src="<? echo $Bild["datei"]; ?>" width="<?=$Bild["breite"];?>" height="<?=$Bild["hoehe"];?>" alt="<? echo htmlspecialchars($Bild["text"]); ?>"/><br />
<? } ?>
<input type="submit" />
</form>
<? } ?>
