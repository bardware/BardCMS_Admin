...
?>
<?
$info=getimagesize($imgStartDir.$_POST["url"]);
$Abfrage="insert into ged_bilder (text, datei, breite, hoehe) values(\"".myAddSlashes($_POST["beschr"])."\", \"".$imgBildURL.$_POST["url"]."\", ".$info[0].", ".$info[1].")";
//echo $Abfrage;
